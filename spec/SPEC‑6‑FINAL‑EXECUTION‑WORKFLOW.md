...
System Coordinator GPT (Điều phối Dự án & Quản trị Luồng CI/CD)	Software Architect GPT	Quản lý luồng CI/CD, đánh giá tiến độ, kiểm soát khóa cứng (Hard Gate, Review Lock), phân phối lệnh làm việc xuống.	Lệnh điều phối, chỉ định task.												
Trợ lý Hỗ trợ Triển khai Dự án (Project Implementation Support Assistant)	Deepseek	Hướng dẫn người dùng (TÔI) thao tác từng bước trên dự án. Soạn sẵn Prompt chuẩn kỹ thuật để copy-paste giao cho Dev AI. Tuyệt đối không tự code.	Hướng dẫn thao tác (từng bước), Prompt giao việc chuẩn, Báo cáo kết quả.												
