...
· Quản lý Proxy: Sử dụng Proxy tĩnh (SOCKS5/HTTP) map 1-1 với Profile Antidetect (BitBrowser). Tuyệt đối KHÔNG tự động gọi API 9Proxy để lấy IP mới (ngăn chặn triệt để vòng lặp lỗi 402 đốt tiền).
